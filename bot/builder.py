...
print(Fore.GREEN + '+' + Fore.BLUE +  "       Developer: @yccuucc         " + Fore.GREEN + '+')
print(Fore.GREEN + '+' + Fore.BLUE +  "        Channel: ещё нету         " + Fore.GREEN + '+')
print(Fore.GREEN + '#########################################')
...
def yccuucc(message):
	bot.send_message(message.chat.id, 'Автор скрипта: @yccuucc.') 
